    ...
    <div className="flex flex-col">
      ...
      >
        <input
          ...
          type="checkbox"
          checked={boolean}
          className="transition-colors bg-red-500 rounded-full appearance-none cursor-pointer checked:bg-green-500 w-14 h-3 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-blue-500"
        />
        <span
