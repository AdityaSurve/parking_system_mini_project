    ...
    <DashboardLayout>
      ...
      <div className="flex flex-col">
        <div className="flex flex-col items-center justify-center gap-4 rounded-lg">
          <div className="relative grid w-full h-18 gap-2 text-2xl font-bold text-white rounded-md">
            <VisionHeader
          ...
          <div className="flex-col -mt-2 hidden gap-4 md:flex md:flex-row md:justify-between">
            <Toolbar
